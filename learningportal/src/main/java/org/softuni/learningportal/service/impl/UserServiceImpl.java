...
import org.softuni.learningportal.domain.entities.User;
import org.softuni.learningportal.domain.models.service.UserServiceModel;
import org.softuni.learningportal.repository.UserRepository;
import org.softuni.learningportal.service.RoleService;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return this.userRepository
                ...
                .orElseThrow(() -> new UsernameNotFoundException("Името не е намерено!"));
    }
    ...
    public void setUserRole(String id, String role) {
        User user = this.userRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("Грешно id!"));
        ...
        switch (role) {
            ...
            case "administrator":
                userServiceModel.getAuthorities().add(this.roleService.findByAuthority("ROLE_USER"));
                userServiceModel.getAuthorities().add(this.roleService.findByAuthority("ROLE_ADMINISTRATOR"));
                break;
            case "admin":
                userServiceModel.getAuthorities().add(this.roleService.findByAuthority("ROLE_USER"));
                userServiceModel.getAuthorities().add(this.roleService.findByAuthority("ROLE_ADMINISTRATOR"));
