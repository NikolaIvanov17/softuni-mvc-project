...
public class BookController extends BaseController {
    ...
    @Autowired
    public BookController(BookService bookService, CategoryService categoryService, BookAddValidator addValidator, ModelMapper modelMapper) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMINISTRATOR')")
    @PageTitle("Edit Book")
    public ModelAndView editBookRequest(@PathVariable String id, ModelAndView modelAndView) {
