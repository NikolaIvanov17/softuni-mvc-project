    ...
    h.cors = !!Gt && "withCredentials" in Gt, h.ajax = Gt = !!Gt, w.ajaxTransport(function (t) {
        ...
        if (h.cors || Gt && !t.crossDomain) return {
            send: function (i, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "templates.error.error" === e ? "number" != typeof s.status ? o(0, "templates.error.error") : o(s.status, s.statusText) : o(Vt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {binary: s.response} : {text: s.responseText}, s.getAllResponseHeaders()))
                    }
                }, s.onload = n(), r = s.onerror = s.ontimeout = n("templates.error.error"), void 0 !== s.onabort ? s.onabort = r : s.onreadystatechange = function () {
            ...
            return {
                send: function (i, o) {
                    t = w("<script>").prop({charset: e.scriptCharset, src: e.url}).on("load error", n = function (e) {
                        t.remove(), n = null, e && o("templates.error.error" === e.type ? 404 : 200, e.type)
